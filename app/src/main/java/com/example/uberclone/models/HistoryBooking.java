...
public class HistoryBooking {
    ...
    public HistoryBooking(String idHistoryBooking, String idClient, String idDriver, String origin, String destination, String time,
                          String km, String status, double originLat, double originLng, double destinationLat, double destinationLng) {
    ...
    public void setIdHostoryBooking(String idHostoryBooking) {
        this.idHistoryBooking = idHostoryBooking;
    }
